...
const PrivacyGuidelines = (): JSX.Element => {
  return (
    <>
      ...
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">1. Data Collection</h2>
      ...
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">2. Data Usage</h2>
      <p className="text-body-large-mobile md:text-body-large-desktop font-medium font-body">
      ...
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">3. Security</h2>
      <p className="text-body-large-mobile md:text-body-large-desktop font-medium font-body">
      ...
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">4. User Rights</h2>
      <p className="text-body-large-mobile md:text-body-large-desktop font-medium font-body">
        Users have the right to access, modify, or delete their personal data.
        Requests can be made through our support team.
      </p>
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">5. Data Storage</h2>
      <p className="text-body-large-mobile md:text-body-large-desktop font-medium font-body">
      ...
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">6. Third-Party Services</h2>
      <p className="text-body-large-mobile md:text-body-large-desktop font-medium font-body">
      ...
      <h2 className="text-body-large-mobile md:text-body-large-desktop font-semibold font-body mt-4">7. Policy Updates</h2>
      <p className="text-body-large-mobile md:text-body-large-desktop font-medium font-body">
