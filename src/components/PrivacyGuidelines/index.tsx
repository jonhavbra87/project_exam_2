const PrivacyGuidelines = () => {
  return (
    <>
      <h1 className="text-2xl font-bold mt-8 mb-4">Privacy Guidelines</h1>
      ...
      <h2 className="text-xl font-semibold mt-4">3. Security</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-4">5. Data Storage</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold mt-4">7. Policy Updates</h2>
      <p>
