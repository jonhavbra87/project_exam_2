...
const BookingCard = ({
  ...
  return (
    <div
      className={`bg-white shadow-md rounded-lg overflow-hidden flex flex-col md:flex-row border ${isExpired ? 'border-gray-400' : 'border-blue-500'}`}
    >
      {/* 📌 Venue-bilde */}
      ...
      <div className="md:w-2/3 p-6 flex flex-col justify-between">
        <div>
          ...
          <p className="text-ingress-mobile md:text-ingress-desktop font-semibold">
            {venue?.location?.country || 'Unknown country'}
          </p>
          <p className="text-body-large-mobile md:text-body-large-desktop text-text-secondary font-medium mt-2">
