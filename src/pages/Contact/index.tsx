    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-1/3 md:mr-8">
          <h2 className="text-h2-mobile md:text-h2-desktop font-heading font-semibold text-text-primary mb-8 text-center md:text-start">
          ...
          <p className="text-body-large-mobile md:text-body-large-desktop font-body font-light text-text-primary mb-4">
            ...
            you! Whether you're a venue manager looking for support, a customer
            with inquiries, or just someone who wants to learn more, our team is
            ready to assist.
          </p>
          <p className="text-body-large-mobile md:text-body-large-desktop font-body font-light text-text-primary mb-4">
            Email Us: Reach out anytime, and we’ll get back to you as soon as
            possible.
          </p>
          <p className="text-body-large-mobile md:text-body-large-desktop font-body font-light text-text-primary mb-4">
            Call Us: Need immediate assistance? Our support team is just a call
            away.
          </p>
          <p className="text-body-large-mobile md:text-body-large-desktop font-body font-light text-text-primary mb-4">
            Live Chat: Get quick answers through our real-time chat feature.
          </p>
          <p className="text-body-large-mobile md:text-body-large-desktop font-body font-light text-text-primary mb-4">
            We value every message and strive to provide the best support
            experience. Don’t hesitate—contact us today, and let’s make your
